--- title: "Implement Queue using Stacks" slug: implement-queue-using-stacks date: "2026-06-22" ---  # My Solution ~~~class MyQueue {
public:
    stack<int> in;
    stack<int> out;
...
- **Concrete Improvements**: 
    ...
    - Consider marking methods as `const` where applicable (though not strictly necessary for this specific competitive programming context).  ---  # Question Revision ### Implement Queue using Stacks
