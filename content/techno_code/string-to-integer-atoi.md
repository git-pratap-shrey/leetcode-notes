--- title: "String to Integer (atoi)" slug: string-to-integer-atoi date: "2026-06-25" ---  # My Solution ~~~class Solution {
public:
    int myAtoi(string s) {
        int n=s.size();
        int i=0;
...
- **Concrete Improvements**:
    ...
    - Adding `const` to `n` would be a minor best-practice improvement.  ---  # Question Revision ### String to Integer (atoi)
