--- title: "Longest Common Subsequence" slug: longest-common-subsequence date: "2026-06-25" ---  # My Solution ~~~class Solution {
public:
...
- **Improvements:** 
    ...
    - Use `size_t` for indices to avoid signed/unsigned comparison warnings with `.size()`.  ---  # Question Revision ### Longest Common Subsequence (LCS)
