...
- **Concrete Improvements:**
    ...
    - Pass `n` by value (already done) but consider using an iterative loop to avoid potential stack overflow for very large $n$ (though $n$ is typically small in this specific problem).
