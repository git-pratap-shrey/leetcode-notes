--- title: "Count Subarrays With Majority Element I" slug: count-subarrays-with-majority-element-i date: "2026-06-25" ---  # My Solution ~~~class Solution {
public:
...
- **Concrete Improvement:** 
    ...
    ```
    This removes the $O(n)$ space overhead and reduces the constant factor of the $O(n^2)$ runtime.  ---  # Question Revision ### Revision Report: Count Subarrays With Majority Element I
