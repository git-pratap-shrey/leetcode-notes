--- title: "Generate Binary Strings Without Adjacent Zeros" slug: generate-binary-strings-without-adjacent-zeros date: "2026-07-08" ---  # My Solution ~~~class Solution {
...
- **Improvements**:
    ...
    - Pass `n` as a constant or use a member variable to avoid passing it through every recursive call.  ---  # Question Revision ### Generate Binary Strings Without Adjacent Zeros
