...
- **Improvement**: The code implicitly ignores any characters that are not lowercase letters ('a'-'z') or digits ('0'-'9'). If the problem definition includes other characters, they are currently excluded from the result.
