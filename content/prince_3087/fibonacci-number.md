--- title: "Fibonacci Number" slug: fibonacci-number date: "2026-06-18" ---  # My Solution ~~~class Solution {
public:
    int fib(int n) {
        if(n==0){
            return 0;
...
- **Improvements**: Replace the recursive calls with a simple `for` loop to avoid stack overflow and redundant computations.  ---  # Question Revision ### Fibonacci Number
